    ...
    <Grid container direction="column">
      <Paper className={classes.marginLeft}>
        ...
        >
          ...
          <Typography variant="subtitle1">Warehouse Entry</Typography>
        </Grid>
        <Grid item container sm={12} className={classes.itemOneMargin}>
          <Input
            inputLabel="Warehouse Id"
            inputPlaceHolder="Enter your Warehouse ID"
          ...
          <Input
            ...
            inputPlaceHolder="Enter your Warehouse Name"
      ...
      <ModalComponent
        ...
        modalText="Warehouse added Successfully"
      />
      <ModalComponent
        modalDialog={modalDialogExists}
        modalText="Warehouse Already Exists"
      />
    </Grid>
  );
};
